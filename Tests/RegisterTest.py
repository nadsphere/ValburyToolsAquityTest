...
class TestRegistration:
    ...
    def _submit_form(self, page, name, email, phone):
    ...
    def test_001_success_register_with_valid_data(self, page):
    ...
    def test_002_failed_register_blank_name(self, page):
    ...
    @pytest.mark.negative_test
    def test_003_failed_register_blank_email(self, page):
    ...
    @pytest.mark.negative_test
    def test_004_failed_register_blank_phone(self, page):
    ...
    @pytest.mark.negative_test
    def test_005_failed_register_blank_name_email(self, page):
    ...
    @pytest.mark.negative_test
    def test_006_failed_register_blank_name_phone_number(self, page):
    ...
    @pytest.mark.negative_test
    def test_007_failed_register_blank_email_phone_number(self, page):
    ...
    @pytest.mark.negative_test
    def test_008_failed_register_all_blank_fields(self, page):
    ...
    def test_009_failed_register_with_registered_email(self, page):
        ...
        assert page.register.is_pop_up_visible(), "Alert modal did not appear"
        assert page.register.get_alert_popup_text() == "Maaf! Anda sudah terdaftar di Valbury"

    @pytest.mark.negative_test
    @pytest.mark.registered
    def test_010_failed_register_with_registered_phone(self, page):
    ...
    @pytest.mark.negative_test
    def test_011_failed_register_with_less_than_character_phone(self, page):
    ...
    @pytest.mark.negative_test
    def test_012_failed_register_with_invalid_phone(self, page):
    ...
    @pytest.mark.negative_test
    def test_013_failed_register_with_less_than_character_name(self, page):
    ...
    @pytest.mark.negative_test
    def test_014_failed_register_with_invalid_name(self, page):
    ...
    @pytest.mark.negative_test
    def test_015_failed_register_invalid_email_format(self, page):
